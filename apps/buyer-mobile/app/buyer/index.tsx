...
export default function Home() {
  ...
  async function submit() {
    ...
    router.push({ pathname: '/buyer/offers', params: { req: JSON.stringify(r.requirement), raw: text } });
  }
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      <ScrollView contentContainerStyle={{ padding: 20, paddingTop: 40 }}>
        ...
        <View style={{ flexDirection: 'row', gap: 8, marginTop: 24 }}>
          <TouchableOpacity onPress={() => router.push('/buyer/profile')} style={{ flex: 1, backgroundColor: colors.card, borderColor: colors.border, borderWidth: 1, borderRadius: 14, padding: 14, alignItems: 'center' }}>
